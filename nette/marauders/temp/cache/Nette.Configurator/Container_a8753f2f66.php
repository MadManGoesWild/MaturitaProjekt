...
class Container_a8753f2f66 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\MaturitaProjekt\nette\marauders\app',
			'wwwDir' => 'C:\xampp\htdocs\MaturitaProjekt\nette\marauders\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\MaturitaProjekt\nette\marauders\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\MaturitaProjekt\nette\marauders\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\MaturitaProjekt\nette\marauders\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\MaturitaProjekt\nette\marauders\app/../temp/cache',
	...
	{
		return new Container_a8753f2f66_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_a8753f2f66_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_a8753f2f66 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\MaturitaProjekt\nette\marauders\app/../temp/cache/latte');
