...
class Container_64575fa680 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		return new Container_64575fa680_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_64575fa680_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_64575fa680 $container)
	{
