<?php
// source: D:\www\marauders\app/config/config.neon 
// source: D:\www\marauders\app/config/config.local.neon 

class Container_89d1d7bc5d extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\www\marauders\app',
			'wwwDir' => 'D:\www\marauders\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'D:\www\marauders\app/../temp',
		];
	}
	...
	/**
	 * @return App\Presenters\FavouriteLocationPresenter
	 */
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\marauders\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\marauders\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\marauders\app/../temp/cache',
	...
	{
		return new Container_89d1d7bc5d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_89d1d7bc5d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_89d1d7bc5d $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\marauders\app/../temp/cache/latte');
